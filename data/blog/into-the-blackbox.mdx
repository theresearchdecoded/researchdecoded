...
$$ P_n\left( (v_1, \dots, v_n) \in K \backslash \{\epsilon\}, \text{ind} = (w_1, \dots, w_n) \right) := \begin{cases} 	1 & \text{if } v_i = w_i \text{ whenever } v_i \neq * \\ 	0 & \text{otherwise} \end{cases} $$
...
4. The predicate $P_{n,p}$ on $K \times I$ is defined as
    $$
    P_{n,p}\left( (v_1, \dots, v_n) \in K \backslash \{\epsilon\}, \text{ind} = (w_1, \dots, w_n) \right) :=
    \begin{cases}
